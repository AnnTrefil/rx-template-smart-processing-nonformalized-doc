...
## Описание
Решение позволяет:
Добавлять блок типа скрипт «Распознавание неформализованных документов электронного обмена», с помощью которого неформализованные документы, поступившие из сервиса электронного обмена Диадок, будут автоматически интеллектуально обрабатываться сервисами Ario. После распознавания сервисами Ario:
●	выполняется изменение типа документа на распознанный;
●	заполняется вид документа по умолчанию; 
●	заполняются стандартные извлеченные реквизиты.
